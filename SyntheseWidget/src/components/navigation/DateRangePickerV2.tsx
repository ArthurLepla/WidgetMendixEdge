    ...
    return (
        <div className="drp-calendar">
            <div className="drp-calendar-header">
                ...
                <h3 className="drp-calendar-title">{format(month, "MMMM yyyy", { locale: fr })}</h3>
                <button
                    type="button"
                    className="drp-calendar-nav"
...
export function DateRangePickerV2({
    ...
    const [date, setDate] = React.useState<DateRange | undefined>(() => {
        if (
            startDateAttribute?.status === ValueStatus.Available ||
            endDateAttribute?.status === ValueStatus.Available
        ) {
            return {
    ...
    React.useEffect(() => {
        ...
        if (open) {
            ...
            setTimeout(() => {
                ...
                if (dropdownElement) {
                    console.log(
                        "DateRangePickerV2: Dropdown element styles:",
    ...
    const handleApply = () => {
        ...
        // Appeler la callback personnalisée si fournie
        if (onCustomDateChange) {
            onCustomDateChange(tempDate.from, tempDate.to);
        }
    ...
    const formatDisplayDate = () => {
        ...
        return `${format(date.from, "dd MMM yyyy, HH:mm", { locale: fr })} - ${format(date.to, "dd MMM yyyy, HH:mm", {
            locale: fr
        })}`;
    };
                                    ...
                                    <div className="drp-container">
                                        ...
                                        <div className="drp-main">
                                            ...
                                            <div className="drp-footer">
                                                <button
                                                    className="drp-button drp-button--secondary"
