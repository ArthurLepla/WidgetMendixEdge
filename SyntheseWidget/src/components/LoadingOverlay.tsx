...
export const LoadingOverlay = ({
    ...
    return (
        <div
            className="loading-isolated fixed inset-0 bg-white/60 backdrop-blur-md z-50 flex items-center justify-center transition-all duration-300"
                ...
                >
                    ...
                    <div className="loader-circle" style={{ position: "relative", display: "flex" }}>
                        ...
                        <div
                            ...
                            style={{ "--pulse-color": currentEnergy.color } as React.CSSProperties}
                        />

                        {/* Cercle animé avec effet lumineux */}
                        <div
                            className="loader-glow-circle"
                            style={{ "--glow-color": currentEnergy.color } as React.CSSProperties}
                        />
                            ...
                            {[...Array(10)].map((_, i) => (
                                <div
                                    ...
                                    style={
                                        {
                                            "--orbit-point-color":
                                                i % 4 === activeEnergy ? currentEnergy.color : "#e5e5e5",
                        ...
                        <div
                            ...
                            style={{ "--icon-bg-color": currentEnergy.color } as React.CSSProperties}
                        />
                        ...
                        <div className="icon-container">
                            <div className="icon-wrapper" key={currentEnergy.name}>
                                ...
                                <div
                                    className="icon-halo"
                                    style={{ "--halo-color": currentEnergy.color } as React.CSSProperties}
                                />

                                {/* Icône qui pulse */}
                                <div
                                    className="icon-pulse"
                                    style={{ "--icon-color": currentEnergy.color } as React.CSSProperties}
                                >
                        ...
                        {particlePositions.map((pos, i) => (
                            <ParticleEffect key={i} position={pos} color={currentEnergy.color} delay={pos.delay} />
                        ))}
                    </div>
                    ...
                    <div
                        ...
                        style={{ "--energy-color": currentEnergy.color } as React.CSSProperties}
                    >
                        <div
                            className="energy-indicator"
                            style={{ "--indicator-color": currentEnergy.color } as React.CSSProperties}
                        />
                        <div
                            className="energy-name"
                            style={{ "--name-color": currentEnergy.color } as React.CSSProperties}
                        >
                            {currentEnergy.name}
                        </div>
                    </div>
