...
export const CardConsoTotal = ({ title, currentValue, previousValue, type, baseUnit = "auto" }: CardConsoTotalProps): ReactElement => {
    ...
    const formattedCurrentValue = hasData ? formatSmartValue(currentValue, type, baseUnit) : { formattedValue: "N/A", displayUnit: "N/A" };
        ...
        <div className={`card-base ${isSignificant && isPositive ? 'bg-red-50' : ''}`}>
            ...
            <div className="mt-4">
                <div className="value-large" style={{ color: config.color }}>
                    {hasData ? formattedCurrentValue.formattedValue : "N/A"} {hasData ? formattedCurrentValue.displayUnit : ""}
                </div>
