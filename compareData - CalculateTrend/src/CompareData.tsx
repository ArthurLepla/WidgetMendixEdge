...
export function CompareData({
    ...
    const handleGranularityModeChange = (mode: "Auto" | "Strict") => {
        ...
        console.log("Granularity mode changed to:", mode);
    };

    const handleGranularityValueChange = (value: number) => {
        setGranularityValue(value);
        console.log("Granularity value changed to:", value);
    };
