...
export function ConsumptionUnavailable({ 
  consumptionCount, 
  fallbackReason, 
  recommendedMode, 
  selectedAssets,
  ...
  const recommendation =
    recommendedMode === "fallback"
      ? "Vérifiez la source de données (XPath) et restez en mode Énergétique."
          ...
          <div style={styles.contentWrapper}>
            ...
            <div style={styles.content}>
              <motion.h2
                ...
                style={styles.title}
              >
                Mode Énergétique non disponible
              </motion.h2>
              ...
              >
                <p style={styles.subtitle}>
                  Les assets sélectionnés ne possèdent pas de données de consommation disponibles
                </p>
                
                <div style={{ marginBottom: '12px' }}>
                  <span style={styles.badge}>
                    {consumptionCount} point{consumptionCount > 1 ? "s" : ""} de consommation disponible{consumptionCount > 1 ? "s" : ""}
                  </span>
                </div>
                  ...
                  >
                    ...
                    {availableAssets.length > 0 && (
                      <div style={{ marginTop: '8px', fontSize: '12px', color: '#6b7280' }}>
                        Assets avec consommation disponibles: {availableAssets.join(', ')}
                      </div>
                    )}
                  </motion.div>
                )}
                  ...
                  <div style={styles.recommendationText}>
                    ...
                    {availableAssets.length > 0 && (
                      <p style={{ fontSize: '14px', color: '#059669', margin: 0 }}>
                        💡 Essayez de sélectionner d'autres assets qui ont des données de consommation disponibles.
                      </p>
                    )}
                  </div>
                </div>
